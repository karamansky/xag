	...
	<div class="tech">
		...
		<div class="tech__content landing">
			<div style="display: none;">
				<div id="m500-video-popup" class="main-video-popup box-modal">
				...
				<div class="wrapper">
					<div class="landing__header-content">
						...
						<?php if(!empty($main_popup_video)) { ?>
							<a href="#m500-video-popup" class="header__videoplay" data-video="https://www.youtube.com/embed/<?php echo $video_code; ?>"><i class="play"></i></a>
						<?php } ?>
					</div>
				</div>
			...
			<?php
				...
				$three_items_description = get_field('three_items_description');
			...
			<section class="three-items">
				<div class="wrapper-fluid">
					<div class="three-items__inner">
						<div class="wrapper">
							<?php if( !empty($three_items_description) ) { ?>
								<div class="three-items__description">
									<?php echo $three_items_description ?>
								</div>
							<?php } ?>
						</div>
						...
						<?php } ?>
						<?php if( !empty($three_items) ) { ?>
							<div class="three-items__blocks">
								<?php foreach ($three_items as $item) { ?>
									<div class="three-items__block">
										<div class="three-items__img">
											<img src="<?php echo $item['image']['url'] ?>" alt="<?php echo strip_tags($item['title']) ?>">
										</div>
										<h3 class="three-items__block-title"><?php echo $item['title'] ?></h3>

	...
	<div class="tech">
		...
		<div class="tech__content landing">
			...
			<section class="landing__header">
				...
				<video autoplay="true" playsinline muted loop="true" id="main-video">
			...
			?>
				<section class="text-content">
					...
					<div class="tech-video-play">
						<video autoplay="true" playsinline muted loop="true" id="video-spray">
...
<!--						<script> document.getElementById('video-spray').play();</script>-->
			...
			?>
				<section class="ip67">
					...
					<div class="tech-video-play">
						<video autoplay="true" playsinline muted loop="true" id="tech-video">
...
<!--						<script> document.getElementById('tech-video').play();</script>-->
			...
			?>
				<section class="x4-video">
					...
					<div class="tech-video-play">
						<video autoplay="true" playsinline muted loop="true" id="x4-video">
...
<!--						<script> document.getElementById('x4-video').play();</script>-->
			...
			?>
				<section class="camera">
					...
					<div class="tech-video-play">
						<video autoplay="true" playsinline muted loop="true" id="camera-video">
...
<!--						<script> document.getElementById('camera-video').play();</script>-->
			...
			?>
				<section class="sowing">
					...
					<div class="tech-video-play">
						<video autoplay="true" playsinline muted loop="true" id="sowing-video">

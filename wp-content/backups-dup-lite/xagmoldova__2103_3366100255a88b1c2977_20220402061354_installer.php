...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'xagmoldova__2103_3366100255a88b1c2977_20220402061354_archive.zip';
	const ARCHIVE_SIZE		 = '1548348972';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3366100-02061354';
    const SECONDARY_PACKAGE_HASH = 'e09ce8a-02061354';
	const VERSION			 = '1.4.4';

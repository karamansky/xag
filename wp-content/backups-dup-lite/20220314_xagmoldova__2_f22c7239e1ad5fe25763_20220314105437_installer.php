...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220314_xagmoldova__2_f22c7239e1ad5fe25763_20220314105437_archive.zip';
	const ARCHIVE_SIZE		 = '1059942675';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f22c723-14105437';
    const SECONDARY_PACKAGE_HASH = '8149b9f-14105437';
	const VERSION			 = '1.4.4';
